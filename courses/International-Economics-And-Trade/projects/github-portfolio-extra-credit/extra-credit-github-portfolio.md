...
Stand up a **public GitHub repository** — a professional portfolio you own — and put two career documents in it: a short **bio** and a **resume**, both written in Markdown. That's the whole assignment.
...
## What you'll do (three small pieces, 3 points)
...
You do **not** need directory folders, a README in every folder, or a polished commit history for this assignment. Just the repo, the bio, and the resume.

---

## Step 1 — Create the public repository (~10 min)
...
Your repo is now live. Everything after this happens inside it.
...
## If you used AI (required disclosure)

If you used any AI tool on the bio or resume, add one line at the bottom of that file, for example:

```md
_Drafted with help from Claude (Anthropic, 2026); reviewed and edited by me._
```

If you didn't use AI, no disclosure is needed. AI use is encouraged, not required — see the AI Use Policy in the [course README](../../BUS-313/README.md).
...
- **Keep it public.** A repo set to Private earns no points because I can't open it. Check in an incognito window.
- **Don't aim for perfection.** A solid, honest bio and resume beat a polished draft you never finish. You can keep editing after you submit — just have something committed by the deadline.
- **Let AI do the heavy lifting, then own the words.** Draft fast, then revise so it sounds like you.
- **This carries forward.** The same public repo is exactly what you'd hand a hiring manager or reuse in a future course — you're not building it just for these 3 points.
