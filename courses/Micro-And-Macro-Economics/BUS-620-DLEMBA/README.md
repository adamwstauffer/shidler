...
**The course has a shape, and it is deliberate: small work first, large work second.** All three
graded cases are introduced in the first four sessions and the last of them is submitted 11 October.
Each is bounded — a spec, a check figure, a deadline weeks out — and each is the method **on rails**.
The research paper is the same method **without rails**, on a question you chose, and it is the last
thing standing. **The front half teaches you the moves. The back half is where nobody tells you which
one to use.**

**All three cases are on the table by 3 September.** That is on purpose, and it is the one place this
section differs sharply from the on-campus one: with sessions doubled up, you get every scenario
early and then work them on a spread-out deadline schedule rather than meeting each one just before
it is due. **Read all three briefs in the first two weeks** — the later cases will make more sense
for having seen where the arc is going.

**This section runs the same course as the on-campus section, condensed.** Same sequence, same
shape, same deliverables — sessions are doubled up and the calendar is shorter.
...
| Case 2 — Imperfect Competition: Pricing Power Analysis | 15% |
| Case 3 — Economic Profit & Rent: Earnings Analysis | 15% |
| Individual Project — Geopolitical Research Paper | 45% |
| **Total** | **100%** |
...
* **Case-Study Projects (3 × 15%):** Three Excel + AI engagements, each worth 20 points split across its graded stages. See below.
* **Individual Project — Geopolitical Research Paper (45%):** Peer evaluation accounts for **50% of the grade**.
...
| :---: | :---: | ----- | ----- | ----- |
| **0** | Sat 15-Aug | **ECON Tutorial** — Thinking Like an Economist · Video: How The Economic Machine Works by Ray Dalio · Discussion on Global Challenges & Geopolitical Risks · **[AI Case Study Overview](https://adamwstauffer.github.io/ai-lms/micro-and-macro-economics.html)**<br>*Pre-work: create a GitHub account before the Residence Weekend* | Case overview | |
| **1** | Fri 21-Aug | Intros<br>**The model, and the shock.** Supply shifts, and why demand does not answer immediately.<br>**Reading:** Ch. 1–2 | **[Case 1 — Perfect Competition](https://adamwstauffer.github.io/ai-lms/case-perfect-competition.html)**<br>**1.0** portfolio repository<br>**1.1** engagement brief | |
| **2** | Sat 22-Aug | ① **Magnitude.** Short-run versus long-run elasticity; why the price does the adjusting when quantity cannot.<br>② **Who gained and who paid.** Surplus, efficiency, and where a windfall actually lands.<br>**Reading:** Ch. 3–5 | **1.2** spec + AI build<br>**1.3** analysis | |
| **3** | Sun 23-Aug | ① **Power.** Market structure, the chokepoint as leverage, and strategic behavior between states.<br>② **Why everyone stayed wrong.** Behavioral economics on a forecast that failed in public.<br>**Reading:** Ch. 6–8 | **[Case 2 — Imperfect Competition](https://adamwstauffer.github.io/ai-lms/case-imperfect-competition.html)**<br>**2.1** model build<br>**2.2** analysis | **[Case 1.0](https://adamwstauffer.github.io/ai-lms/github-stage0.html)** · 23-Aug |
| **4** | Thu 3-Sep | **Costs nobody was billed for.** Externalities and property rights — and who owns a sea lane. Video (in-class): ***The Grab***<br>**Reading:** Ch. 9–10 | **[Case 3 — Economic Profit & Rent](https://adamwstauffer.github.io/ai-lms/case-economic-profit.html)**<br>**3.1** model build<br>**3.2** analysis | **[Case 1.1](https://adamwstauffer.github.io/ai-lms/case-perfect-competition-stage1.html)** · 30-Aug |
| **5** | Thu 10-Sep | **Rerouting.** Trade, tariffs, and what it costs to move oil the long way. Spotlight: WTO, World Order & Climate Change<br>**Reading:** Ch. 11–12 | | **[Case 1.2](https://adamwstauffer.github.io/ai-lms/case-perfect-competition-stage2.html)** · 6-Sep |
| **6** | Thu 17-Sep | **The aggregate.** How a shock shows up in GDP, unemployment and the inflation print. **[Introduce: Individual Research Paper](https://adamwstauffer.github.io/ai-lms/team-case-study.html)**<br>**Reading:** Ch. 13 | | **[Case 1.3](https://adamwstauffer.github.io/ai-lms/case-perfect-competition-stage3.html)** · 13-Sep |
| **7** | Sat 19-Sep | **Work.** Growth, productivity, and who loses a job to an energy shock. **In-Class Study: AI in the Workforce** · Video: AI — A New Paradigm · [Citrini, *2028 Global Intelligence Crisis*](https://www.citriniresearch.com/p/2028gic) · Video: Principles for Dealing with the Changing World Order (Dalio)<br>**Reading:** Ch. 14–15 | | **[Case 2.1](https://adamwstauffer.github.io/ai-lms/case-imperfect-competition-stage1.html)** · 20-Sep |
| **8** | Thu 24-Sep | **Money.** Saving, capital formation, the Fed, and global financial plumbing. **Case Study: the Global Financial Crisis** — predict from July 2007, then see March 2009 · Side discussion: Investment Management, Trading & Market Making<br>**Reading:** Ch. 16–17 | | **[Case 2.2](https://adamwstauffer.github.io/ai-lms/case-imperfect-competition-stage2.html)** · 27-Sep |
| **9** | Thu 1-Oct | **Response.** Fluctuations, fiscal policy, and whether stabilization helped or hurt.<br>**Reading:** Ch. 18–19 | | **[Case 3.1](https://adamwstauffer.github.io/ai-lms/case-economic-profit-stage1.html)** · 4-Oct |
| **10** | Thu 8-Oct | **The open economy.** Aggregate demand and supply, inflation, and the exchange rate. Discussion: analysis of current Fed policy · **Research-paper workshop** — thesis, sources, structure<br>**Reading:** Ch. 20–21 | | **[Case 3.2](https://adamwstauffer.github.io/ai-lms/case-economic-profit-stage2.html)** · 11-Oct |
...
**Case 4 — the Global Financial Crisis (Session 9, in class, ungraded).** Not a fourth graded
...
**It is deliberately the last thing standing.** The three cases are bounded engagements with a spec,
