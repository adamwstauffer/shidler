...
| **7** | 13-Oct | **Micro 13 · Why nations trade** · *Act V — Across the border*<br>**Rerouting.** Comparative advantage, freight, and what it costs to move oil the long way.<br>**Reading:** Ch. 11 — International Trade | | |
| **8** | 20-Oct | **Macro 2 · Measuring the economy** · *Act I — The desk*<br>**The aggregate.** How a shock shows up in GDP, unemployment and the inflation print. **[Introduce: Individual Research Paper](https://adamwstauffer.github.io/ai-lms/team-case-study.html)** · **Case 4 (ungraded):** sealed predictions collected in class — March 2009 unemployment, house prices off peak, whether a top-ten institution fails, and what would prove you wrong<br>**Reading:** Ch. 13 — Measuring Economic Activity | | **[Case 1.3](https://adamwstauffer.github.io/ai-lms/case-perfect-competition-stage3.html)** · 23-Oct |
...
| **13** | 24-Nov | **Micro 14 · Tariffs, trade wars and economic warfare** · *Act V — Across the border*<br>**THANKSGIVING WEEK** · In-class exercise: Trade Wars — impact on national and global economies · Spotlight: WTO, World Order & Climate Change · Spotlight: Immigration — legal and illegal; current events · Team meeting in prep for end-of-semester presentation<br>**Reading:** Ch. 11 — International Trade · Ch. 10 — Making Policy Choices | Team case prep | |
...
**Two chapters have no session of their own and are read alongside one:** **Micro 6 · Consumer
choice** with Session 4, and **Micro 12 · Information and judgment** with Session 6. Both are
examinable. **Textbook Chapter 12 (*Macro: The Bird's-Eye View*) is not assigned to a session** —
what changes when you move from one market to a whole economy runs through Sessions 7 and 8 rather
than owning one. Read it alongside Session 8; it is examinable too.
