...
> that owns it, and Cases 2 and 3 are optional — ungraded, self-paced, off the schedule. **Revised
> again 2026-09-07:** surplus and market efficiency moves ahead of imperfect competition, cartels
> becomes a chapter of its own, and the micro chapters after it each move up one number. **No
> session date, deliverable or deadline changed.**
...
| **3** | 15-Sep | **Micro 2 · Elasticity** *(the remainder)* · *Act I — The story* + **Micro 5 · Profit, measured two ways** + **Micro 6 · Consumer choice** · *Act II — The machinery interlude*<br>**Elasticity finished, then what it earns and what a buyer will do.** The rest of the one ratio; accounting versus economic profit and economic rent; and the choice behind a demand curve.<br>**Reading:** none new — elasticity's chapter came 1 September and this session finishes it. **No textbook chapter for economic rent (Micro 5); the deck is the reading.** **No textbook chapter for the consumer-choice geometry (Micro 6); the deck is the reading.** | **1.2** spec + AI build | **[Case 1.0](https://adamwstauffer.github.io/ai-lms/github-stage0.html)** · 18-Sep |
| **4** | 22-Sep | **Micro 7 · Surplus and market efficiency** · *Act II — The machinery closes*<br>**Who gained and who paid.** Surplus, efficiency, and where a windfall actually lands — the ruler every argument after this one measures with.<br>**Reading:** Ch. 5 — Efficiency and Exchange *(the textbook files surplus and the loss triangle in the trade chapter, which comes 20 October)* | **1.3** analysis | |
| **5** | 29-Sep | **Micro 8 · Imperfect competition** + **Micro 9 · Cartels** · *Act III — Power, and what it costs*<br>**Power, and the promise everyone is paid to break.** Market structure and the chokepoint as leverage; then why a cartel holds a price up, and why each member's best move is to cheat.<br>**Reading:** Ch. 6 — Monopoly and Oligopoly *(the prisoner's dilemma behind a cartel is in the games chapter, which comes 6 October)* | | **[Case 1.1](https://adamwstauffer.github.io/ai-lms/case-perfect-competition-stage1.html)** · 2-Oct |
...
**One session adds no new chapter** — 15 September finishes elasticity, whose chapter came
1 September, beside two subjects the textbook files nowhere. Where the textbook files a subject
somewhere you would not look — surplus in the trade chapter, adverse selection in the policy
chapter — the row points at it rather than assigning it twice. Everything
