"""Shared zip-extraction helper for the FIN-321 grading scripts.
...
("zipslip"). The submission zips come from the LMS (Lamaku) export, which in
turn bundles student-uploaded files — treat them as untrusted.
...
Ported verbatim from the BUS-629 performance-ratios toolchain.
"""
