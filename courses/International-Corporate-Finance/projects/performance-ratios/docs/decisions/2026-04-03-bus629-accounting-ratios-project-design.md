...
**Collaboration model:** Individual. Each student creates their own GitHub repository. The course repository (`courses/International-Corporate-Finance/BUS-629-VEMBA/`) serves as a **living example** — students replicate this structure in their own repos.
...
**A living example of this structure** — with populated READMEs in every directory — is available in the course repository at [`courses/International-Corporate-Finance/projects/performance-ratios/`](../../).
...
- BUS-314 Accounting Ratios Project (archived) — `_archive/bus314/accounting-ratios/`
...
- BUS-629 Memo Template — `docs/templates/memo-template.md`
- BUS-629 Spec Template — `docs/templates/spec-template.md`
- BUS-629 Living Example (directory structure) — `courses/International-Corporate-Finance/projects/performance-ratios/`
