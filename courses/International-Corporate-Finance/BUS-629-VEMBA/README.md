...
[Stage 1](../projects/performance-ratios/stage1-template-architecture.md) |
[Stage 2](../projects/performance-ratios/stage2-company-selection-memo.md) |
[Stage 3](../projects/performance-ratios/stage3-model-population-validation.md) |
...
`courses/International-Corporate-Finance/projects/performance-ratios/` (the shared project this offering uses) serves as a **living example** of the directory structure students should replicate in their own repos. Each directory contains a `README.md` explaining its purpose and conventions.
...
Shared curriculum (stage docs, grading tools, models) lives in [`../projects/performance-ratios/`](../projects/performance-ratios/) — see that directory's README for its full contents.
